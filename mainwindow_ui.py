...
"}")
    ...
    def retranslateUi(self, Nugget):
        Nugget.setWindowTitle(QCoreApplication.translate("Nugget", u"金块", None))
        self.centralwidget.setProperty("cls", QCoreApplication.translate("Nugget", u"中央", None))
        self.devicePicker.setPlaceholderText(QCoreApplication.translate("Nugget", u"空", None))
        self.refreshBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"按钮", None))
        self.titleBar.setText(QCoreApplication.translate("Nugget", u"金块", None))
        self.homePageBtn.setText(QCoreApplication.translate("Nugget", u"    主页", None))
        self.homePageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.gestaltPageBtn.setText(QCoreApplication.translate("Nugget", u"     移动格式塔", None))
        self.gestaltPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.featureFlagsPageBtn.setText(QCoreApplication.translate("Nugget", u"    功能标记", None))
        self.featureFlagsPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.euEnablerPageBtn.setText(QCoreApplication.translate("Nugget", u"    合格", None))
        self.euEnablerPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.springboardOptionsPageBtn.setText(QCoreApplication.translate("Nugget", u"    跳板选项", None))
        self.springboardOptionsPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.internalOptionsPageBtn.setText(QCoreApplication.translate("Nugget", u"    内部选项", None))
        self.internalOptionsPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.daemonsPageBtn.setText(QCoreApplication.translate("Nugget", u"    守护进程", None))
        self.daemonsPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.advancedPageBtn.setText(QCoreApplication.translate("Nugget", u"    风险选项", None))
        self.advancedPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.applyPageBtn.setText(QCoreApplication.translate("Nugget", u"    应用", None))
        self.applyPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.settingsPageBtn.setText(QCoreApplication.translate("Nugget", u"    设置", None))
        self.settingsPageBtn.setProperty("cls", QCoreApplication.translate("Nugget", u"侧边栏按钮", None))
        self.phoneNameLbl.setText(QCoreApplication.translate("Nugget", u"手机", None))
        self.phoneVersionLbl.setText(QCoreApplication.translate("Nugget", u"<a style=\"text-decoration:none; color: white\" href=\"#\">版本号</a>", None))
        self.bigNuggetBtn.setText(QCoreApplication.translate("Nugget", u"...", None))
        self.label_2.setText(QCoreApplication.translate("Nugget", u"金块", None))
        self.discordBtn.setText(QCoreApplication.translate("Nugget", u"  加入 Discord", None))
        self.starOnGithubBtn.setText(QCoreApplication.translate("Nugget", u"Github点个星标", None))
        ...
        self.toolButton_14.setText(QCoreApplication.translate("Nugget", u"主要开发者", None))
        self.helpFromBtn.setText(QCoreApplication.translate("Nugget", u"在以下人员的帮助下", None))
...
"Quiet Daemon", None))
        self.toolButton_15.setText(QCoreApplication.translate("Nugget", u"其他致谢", None))
        ...
        self.statusBarLbl.setText(QCoreApplication.translate("Nugget", u"移动格式塔", None))
        self.mgaWarningLbl.setText(QCoreApplication.translate("Nugget", u"! 您需要一个 Mobile Gestalt 文件才能使用此功能。请在应用页面中选择它！", None))
        self.label_9.setText(QCoreApplication.translate("Nugget", u"设备子类型预设", None))
        self.dynamicIslandDrp.setItemText(0, QCoreApplication.translate("Nugget", u"空", None))
        ...
        self.dynamicIslandDrp.setCurrentText(QCoreApplication.translate("Nugget", u"空", None))
        self.rdarFixChk.setText(QCoreApplication.translate("Nugget", u"修复 RDAR（修改分辨率）", None))
        self.modelNameChk.setText(QCoreApplication.translate("Nugget", u"更改设备型号名称", None))
        self.modelNameTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"型号名称", None))
        self.bootChimeChk.setText(QCoreApplication.translate("Nugget", u"启用开机铃声", None))
        self.chargeLimitChk.setText(QCoreApplication.translate("Nugget", u"启用充电限制", None))
        self.tapToWakeChk.setText(QCoreApplication.translate("Nugget", u"启用点击唤醒（适用于 iPhone SE）", None))
        ...
        self.stageManagerChk.setText(QCoreApplication.translate("Nugget", u"启用 Stage Manager 支持（警告：在某些设备上存在风险，主要是手机）", None))
        self.enableMedusaChk.setText(QCoreApplication.translate("Nugget", u"启用 Medusa（iPad 多任务）（警告：在某些手机上可能有风险）", None))
        self.ipadAppsChk.setText(QCoreApplication.translate("Nugget", u"允许在 iPhone 上使用 iPad 应用程序", None))
        self.shutterChk.setText(QCoreApplication.translate("Nugget", u"禁用区域限制（例如快门声音）", None))
        self.findMyFriendsChk.setText(QCoreApplication.translate("Nugget", u"启用“查找我的朋友”", None))
        self.pencilChk.setText(QCoreApplication.translate("Nugget", u"启用 Apple Pencil 设置选项卡", None))
        self.actionButtonChk.setText(QCoreApplication.translate("Nugget", u"启用操作按钮设置选项卡", None))
        self.internalInstallChk.setText(QCoreApplication.translate("Nugget", u"设置为 Apple 内部安装（即任何应用程序中的 Metal HUD）", None))
        self.internalStorageChk.setText(QCoreApplication.translate("Nugget", u"启用内部存储（警告：对某些设备（主要是 iPad）有风险）", None))
        self.collisionSOSChk.setText(QCoreApplication.translate("Nugget", u"启用碰撞 SOS", None))
        self.aodChk.setText(QCoreApplication.translate("Nugget", u"启用始终显示", None))
        self.label_10.setText(QCoreApplication.translate("Nugget", u"自定义格式塔键", None))
        self.addGestaltKeyBtn.setText(QCoreApplication.translate("Nugget", u"  添加密钥", None))
        self.label_12.setText(QCoreApplication.translate("Nugget", u"警告：错误使用此功能可能会导致启动循环和数据丢失。仅在您知道的情况下使用\n"
"你在做什么。", None))
        self.internalOptionsLbl.setText(QCoreApplication.translate("Nugget", u"功能标记", None))
        self.clockAnimChk.setText(QCoreApplication.translate("Nugget", u"启用锁屏时钟动画", None))
        self.lockscreenChk.setText(QCoreApplication.translate("Nugget", u"启用重复锁屏按钮和锁屏快速切换", None))
        self.photosChk.setText(QCoreApplication.translate("Nugget", u"启用旧照片 UI", None))
        self.aiChk.setText(QCoreApplication.translate("Nugget", u"启用 Apple Intelligence", None))
        self.eligibilityLbl.setText(QCoreApplication.translate("Nugget", u"资格调整", None))
        self.euEnablerEnabledChk.setText(QCoreApplication.translate("Nugget", u"启用欧盟侧载", None))
        self.label_5.setText(QCoreApplication.translate("Nugget", u"方法类型", None))
        self.methodChoiceDrp.setItemText(0, QCoreApplication.translate("Nugget", u"方法一", None))
        self.methodChoiceDrp.setItemText(1, QCoreApplication.translate("Nugget", u"方法二", None))

        self.label_6.setText(QCoreApplication.translate("Nugget", u"区域代码（应为 2 个字母）", None))
        self.regionCodeTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"区域代码（默认：美国）", None))
        self.mgaWarningLbl2.setText(QCoreApplication.translate("Nugget", u"! 您需要一个 MobileGestalt 文件才能使用此功能。请在应用页面中选择它 !", None))
        self.enableAIChk.setText(QCoreApplication.translate("Nugget", u"启用 Apple Intelligence（针对不受支持的设备）", None))
        self.eligFileChk.setText(QCoreApplication.translate("Nugget", u"启用资格文件", None))
        self.languageLbl.setText(QCoreApplication.translate("Nugget", u"语言代码（英语不需要）", None))
        self.languageTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"语言代码(例如 i.e. en)", None))
        self.aiInfoLabel.setText(QCoreApplication.translate("Nugget", u"为了下载 AI 模型，您必须伪造您的设备型号。但是，这可能会破坏 Face ID，直到您恢复。 \n"
"\n"
"警告：解除欺骗后，请勿进入“设置”应用中的 Apple Intelligence 菜单。\n"
"\n"
"在原始设备型号上进入菜单将导致重新下载，并可能需要完全还原才能修复。此外，如果您在型号组之间切换，例如从iPhone 16s到iPhone 15 Pro系列的欺骗，也可能会发生重新下载。 \n"
"请小心！", None))
        self.label_8.setText(QCoreApplication.translate("Nugget", u"欺骗设备型号", None))
        self.spoofedModelDrp.setItemText(0, QCoreApplication.translate("Nugget", u"默认", None))
        ...
        self.spoofedModelDrp.setCurrentText(QCoreApplication.translate("Nugget", u"默认", None))
        self.springboardOptionsLbl.setText(QCoreApplication.translate("Nugget", u"跳板选项", None))
        self.label_13.setText(QCoreApplication.translate("Nugget", u"锁定屏幕脚注文本", None))
        self.footnoteTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"脚注文本", None))
        self.disableLockRespringChk.setText(QCoreApplication.translate("Nugget", u"重启后禁用锁定", None))
        self.disableDimmingChk.setText(QCoreApplication.translate("Nugget", u"充电时禁用屏幕变暗", None))
        self.disableBatteryAlertsChk.setText(QCoreApplication.translate("Nugget", u"禁用低电量警报", None))
        self.disableCrumbChk.setText(QCoreApplication.translate("Nugget", u"禁用面包屑", None))
        self.enableSupervisionTextChk.setText(QCoreApplication.translate("Nugget", u"在锁定屏幕上显示监管文本", None))
        self.enableAirPlayChk.setText(QCoreApplication.translate("Nugget", u"为 Stage Manager 启用 AirPlay 支持", None))
        self.internalOptionsLbl1.setText(QCoreApplication.translate("Nugget", u"内部选项", None))
        self.buildVersionChk.setText(QCoreApplication.translate("Nugget", u"在状态栏中显示构建版本", None))
        self.RTLChk.setText(QCoreApplication.translate("Nugget", u"强制从右到左布局", None))
        ...
        self.IDSChk.setText(QCoreApplication.translate("Nugget", u"启用连续性调试", None))
        self.VCChk.setText(QCoreApplication.translate("Nugget", u"启用 FaceTime 调试", None))
        self.appStoreChk.setText(QCoreApplication.translate("Nugget", u"启用 App Store 调试手势", None))
        self.notesChk.setText(QCoreApplication.translate("Nugget", u"启用 Notes 调试模式", None))
        self.showTouchesChk.setText(QCoreApplication.translate("Nugget", u"显示带有调试信息的触摸", None))
        self.hideRespringChk.setText(QCoreApplication.translate("Nugget", u"隐藏注销图标", None))
        self.enableWakeVibrateChk.setText(QCoreApplication.translate("Nugget", u"抬起唤醒时振动", None))
        self.pasteSoundChk.setText(QCoreApplication.translate("Nugget", u"粘贴时播放声音", None))
        self.notifyPastesChk.setText(QCoreApplication.translate("Nugget", u"显示系统粘贴通知", None))
        self.daemonsLbl.setText(QCoreApplication.translate("Nugget", u"守护进程", None))
        self.thermalmonitordChk.setText(QCoreApplication.translate("Nugget", u"禁用分析报告", None))
        self.otadChk.setText(QCoreApplication.translate("Nugget", u"禁用 OTA", None))
        self.usageTrackingAgentChk.setText(QCoreApplication.translate("Nugget", u"禁用 UsageTrackingAgent", None))
        self.gameCenterChk.setText(QCoreApplication.translate("Nugget", u"禁用游戏中心", None))
        self.screenTimeChk.setText(QCoreApplication.translate("Nugget", u"禁用屏幕时间代理", None))
        self.crashReportsChk.setText(QCoreApplication.translate("Nugget", u"禁用日志、转储和崩溃报告", None))
        self.tipsChk.setText(QCoreApplication.translate("Nugget", u"禁用提示服务", None))
        self.advancedOptionsLbl.setText(QCoreApplication.translate("Nugget", u"风险提醒", None))
        self.label_17.setText(QCoreApplication.translate("Nugget", u"免责声明：\n"
"\n"
"此页面上的选项可能对您的设备不安全。使用这些选项时，您需要自行承担风险。 \n"
"如果使用不当，更改设备分辨率可能会导致设备损坏。\n"
"\n"
"如果您的设备损坏了，尤其是分辨率转换器，Nugget 概不负责。", None))
        self.disableOTAChk.setText(QCoreApplication.translate("Nugget", u"禁用 OTA 更新", None))
        self.enableResolutionChk.setText(QCoreApplication.translate("Nugget", u"设置自定义设备分辨率", None))
        self.resHeightLbl.setText(QCoreApplication.translate("Nugget", u"高度：", None))
        self.resHeightTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"分辨率高度", None))
        self.resHeightWarningLbl.setText(QCoreApplication.translate("Nugget", u"!", None))
        self.resWidthLbl.setText(QCoreApplication.translate("Nugget", u"宽度：", None))
        self.resWidthTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"分辨率宽度", None))
        self.resWidthWarningLbl.setText(QCoreApplication.translate("Nugget", u"!", None))
        self.statusBarLbl_5.setText(QCoreApplication.translate("Nugget", u"应用", None))
        self.label_16.setText("")
        self.modifiedTweaksLbl.setText(QCoreApplication.translate("Nugget", u"当前格式塔文件位置：", None))
        self.gestaltLocationLbl.setText(QCoreApplication.translate("Nugget", u"空", None))
        self.chooseGestaltBtn.setText(QCoreApplication.translate("Nugget", u"  选择格式塔文件", None))
        self.applyTweaksBtn.setText(QCoreApplication.translate("Nugget", u"  应用更改", None))
        self.statusLbl.setText(QCoreApplication.translate("Nugget", u"准备好！", None))
        self.removeTweaksBtn.setText(QCoreApplication.translate("Nugget", u"删除所有调整", None))
        self.resetGestaltBtn.setText(QCoreApplication.translate("Nugget", u"重置移动格式塔", None))
        self.springboardOptionsLbl1.setText(QCoreApplication.translate("Nugget", u"金块设置", None))
        self.allowWifiApplyingChk.setText(QCoreApplication.translate("Nugget", u"允许通过 WiFi 申请", None))
        self.autoRebootChk.setText(QCoreApplication.translate("Nugget", u"应用后自动重启", None))
        self.showRiskyChk.setText(QCoreApplication.translate("Nugget", u"显示有风险的调整选项", None))
        self.skipSetupChk.setText(QCoreApplication.translate("Nugget", u"跳过设置*（仅限非漏洞文件）", None))
        self.supervisionChk.setText(QCoreApplication.translate("Nugget", u"启用监督*（需要跳过设置）", None))
        self.supervisionOrganization.setPlaceholderText(QCoreApplication.translate("Nugget", u"输入组织名称", None))
        self.label_15.setText(QCoreApplication.translate("Nugget", u"* 注意：跳过设置可能会导致配置文件出现问题。如果需要，请将其关闭。", None))
        self.resetPairBtn.setText(QCoreApplication.translate("Nugget", u"重置设备配对", None))
        self.statusBarLbl_2.setText(QCoreApplication.translate("Nugget", u"位置模拟n", None))
        self.label_4.setText("")
        self.loadLocSimBtn.setText(QCoreApplication.translate("Nugget", u"开始位置模拟", None))
        self.label_7.setText(QCoreApplication.translate("Nugget", u"纬度", None))
        self.latitudeTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"XXX.XXXXX", None))
        self.label_11.setText(QCoreApplication.translate("Nugget", u"经度", None))
        self.longitudeTxt.setPlaceholderText(QCoreApplication.translate("Nugget", u"XXX.XXXXX", None))
        self.setLocationBtn.setText(QCoreApplication.translate("Nugget", u"设置位置", None))
        self.resetLocationBtn.setText(QCoreApplication.translate("Nugget", u"重置位置", None))
        self.customOperationsLbl.setText(QCoreApplication.translate("Nugget", u"自定义操作", None))
        self.label_14.setText("")
        self.importOperationBtn.setText(QCoreApplication.translate("Nugget", u"  导入 .cowperation", None))
        self.newOperationBtn.setText(QCoreApplication.translate("Nugget", u"  新行动", None))
        self.exploreLbl.setText(QCoreApplication.translate("Nugget", u"探索", None))
        self.exploreSubLbl.setText("")
        self.themesLbl.setText(QCoreApplication.translate("Nugget", u"移动格式塔修改", None))
        self.importThemeBtn.setText(QCoreApplication.translate("Nugget", u"导入主题：", None))
        ...
        self.label_3.setText(QCoreApplication.translate("Nugget", u"自定义单个应用程序", None))
        self.hideNamesBtn.setText(QCoreApplication.translate("Nugget", u"隐藏/显示所有应用程序名称", None))
        self.borderAllBtn.setText(QCoreApplication.translate("Nugget", u"全部切换 \"边界\"", None))
        self.addAllBtn.setText(QCoreApplication.translate("Nugget", u"全部切换 \"添加到设备\"", None))
    # retranslateUi
